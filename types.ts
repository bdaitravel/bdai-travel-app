...
export interface Stop {
  ...
  imageUrl?: string; 
  curiosity?: string;
  gossip?: string; // Nuevo campo para chismes locales o secretos picantes
  photoShot?: {
    angle: string;
    bestTime: string;
...
export const INTERESTS_LIST = [
  'History', 'Food & Drink', 'Art & Culture', 'Photography', 'Nature & Outdoors', 'Architecture', 'Nightlife', 'Shopping'
];
...
export const TRANSLATIONS: Record<string, any> = {
  es: {
    ...
    insiderGossip: "Chisme de Local", localSecret: "Secreto Guardado",
    tourGuidePersona: "Tu Guía Free Tour"
  },
  en: {
    ...
    insiderGossip: "Insider Gossip", localSecret: "Local Secret",
    tourGuidePersona: "Your Free Tour Guide"
  }
};
