...
interface LoginViewProps {
  ...
  setLoginPhase: (phase: 'EMAIL' | 'OTP') => void;
  handleVerifyOtp: () => void;
  handleLangChange: (code: string) => void;
  user: UserProfile;
}

export const LoginView: React.FC<LoginViewProps> = ({
  loginPhase, email, setEmail, isLoading, t,
  handleRequestOtp, handleGoogleLogin, otpToken, setOtpToken,
  setLoginPhase, handleVerifyOtp, handleLangChange, user
}) => (
