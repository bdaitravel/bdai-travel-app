...
interface CityDetailViewProps {
  ...
  processCitySelection: (selection: any, lang: string, force?: boolean) => void;
  tours: Tour[];
  setActiveTour: (tour: Tour) => void;
}

export const CityDetailView: React.FC<CityDetailViewProps> = ({
  slug, selectedCityInfo, user, navigate, processCitySelection, tours, setActiveTour
}) => (
