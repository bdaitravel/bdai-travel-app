...
export const translations: Record<string, any> = {
  en: {
    ...
    shareRankMessage: "I just reached {rank} rank on BDAI! I've traveled {miles} miles conquering the world. Check it out at {appUrl}",
  ...
  es: {
    ...
    shareRankMessage: "¡He alcanzado el rango {rank} en BDAI! He recorrido {miles} millas conquistando el mundo. Míralo en {appUrl}",
  ...
  fr: {
    ...
    shareRankMessage: "Je viens d'atteindre le rang {rank} sur BDAI ! J'ai parcouru {miles} miles à la conquête du monde. Découvrez-le sur {appUrl}",
  ...
  de: {
    ...
    shareRankMessage: "Ich habe gerade den Rang {rank} auf BDAI erreicht! Ich bin {miles} Meilen gereist, um die Welt zu erobern. Schau es dir an unter {appUrl}",
  ...
  it: {
    ...
    shareRankMessage: "Ho appena raggiunto il rango {rank} su BDAI! Ho percorso {miles} miglia conquistando il mondo. Dai un'occhiata su {appUrl}",
  ...
  pt: {
    ...
    shareRankMessage: "Acabei de atingir o rank {rank} no BDAI! Viajei {miles} milhas conquistando o mundo. Confira em {appUrl}",
  ...
  nl: {
    ...
    shareRankMessage: "Ik heb zojuist rang {rank} bereikt op BDAI! Ik heb {miles} mijl gereisd om de wereld te veroveren. Bekijk het op {appUrl}",
  ...
  ro: {
    ...
    shareRankMessage: "Tocmai am atins rangul {rank} pe BDAI! Am parcurs {miles} mile cucerind lumea. Verifică pe {appUrl}",
  ...
  pl: {
    ...
    shareRankMessage: "Właśnie osiągnąłem rangę {rank} w BDAI! Przejechałem {miles} mil, podbijając świat. Sprawdź to na {appUrl}",
  ...
  sv: {
    ...
    shareRankMessage: "Jag har precis nått rank {rank} på BDAI! Jag har rest {miles} miles och erövrat världen. Kolla in det på {appUrl}",
  ...
  da: {
    ...
    shareRankMessage: "Jeg har lige opnået rang {rank} på BDAI! Jeg har rejst {miles} miles og erobret verden. Tjek det ud på {appUrl}",
    ...
    shareRankMessage: "Olen juuri saavuttanut {rank} arvon BDAI:ssa! Olen matkustanut {miles} mailia valloittaen maailmaa. Katso se osoitteessa {appUrl}",
  ...
  no: {
    ...
    shareRankMessage: "Jeg har nettopp nådd rang {rank} på BDAI! Jeg har reist {miles} miles og erobret verden. Sjekk det ut på {appUrl}",
  ...
  ru: {
    ...
    shareRankMessage: "Я только что достиг ранга {rank} в BDAI! Я проехал {miles} миль, покоряя мир. Проверьте это на {appUrl}",
  ...
  zh: {
    ...
    shareRankMessage: "我刚刚在BDAI达到了{rank}等级！我已经征服了世界，旅行了{miles}英里。请在{appUrl}查看",
  ...
  ja: {
    ...
    shareRankMessage: "BDAIで{rank}ランクに到達しました！世界を征服するために{miles}マイル旅しました。{appUrl}でチェックしてください",
  ...
  ko: {
    ...
    shareRankMessage: "BDAI에서 {rank} 등급에 도달했습니다! 세계를 정복하며 {miles}마일을 여행했습니다. {appUrl}에서 확인하세요",
  ...
  ar: {
    ...
    shareRankMessage: "لقد وصلت للتو إلى رتبة {rank} في BDAI! لقد سافرت {miles} أميال غازيًا العالم. تحقق من ذلك على {appUrl}",
  ...
  hi: {
    ...
    shareRankMessage: "मैंने अभी BDAI पर {rank} रैंक प्राप्त की है! मैंने दुनिया को जीतने के लिए {miles} मील की यात्रा की है। इसे {appUrl} पर देखें",
  ...
  th: {
    ...
    shareRankMessage: "ฉันเพิ่งถึงอันดับ {rank} ใน BDAI! ฉันเดินทาง {miles} ไมล์เพื่อพิชิตโลก ตรวจสอบได้ที่ {appUrl}",
  ...
  vi: {
    ...
    shareRankMessage: "Tôi vừa đạt cấp bậc {rank} trên BDAI! Tôi đã đi {miles} dặm chinh phục thế giới. Hãy xem tại {appUrl}",
  ...
  ca: {
    ...
    shareRankMessage: "Acabo d'aconseguir el rang {rank} a BDAI! He recorregut {miles} milles conquerint el món. Mira-ho a {appUrl}",
  ...
  eu: {
    ...
    shareRankMessage: "BDAI-n {rank} maila lortu dut! {miles} milia egin ditut mundua konkistatzen. Ikusi {appUrl} helbidean",
  ...
  tr: {
    ...
    shareRankMessage: "BDAI'da {rank} rütbesine ulaştım! Dünyayı fethederek {miles} mil yol katettim. {appUrl} adresinden kontrol edin",
