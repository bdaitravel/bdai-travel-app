...
export const translations: Record<string, any> = {
  en: { 
    ...
    navRanking: "ranking", navTOP: "top", navVisa: "passport", navStore: "store",
  ...
  es: { 
    ...
    navRanking: "clasificación", navTOP: "destacados", navVisa: "pasaporte", navStore: "tienda",
  ...
  fr: { 
    ...
    navRanking: "classement", navTOP: "top", navVisa: "passeport", navStore: "boutique",
  ...
  de: { 
    ...
    navRanking: "Rangliste", navTOP: "top", navVisa: "pass", navStore: "laden",
  ...
  it: { 
    ...
    navRanking: "classifica", navTOP: "top", navVisa: "passaporto", navStore: "negozio",
  ...
  pt: { 
    ...
    navRanking: "classificação", navTOP: "top", navVisa: "passaporte", navStore: "loja",
  ...
  nl: { 
    ...
    navRanking: "ranglijst", navTOP: "top", navVisa: "paspoort", navStore: "winkel",
  ...
  ro: { 
    ...
    navRanking: "clasament", navTOP: "top", navVisa: "pașaport", navStore: "magazin",
  ...
  pl: { 
    ...
    navRanking: "ranking", navTOP: "top", navVisa: "paszport", navStore: "sklep",
  ...
  sv: { 
    ...
    navRanking: "rankning", navTOP: "topp", navVisa: "pass", navStore: "butik",
  ...
  da: { 
    ...
    navRanking: "rangliste", navTOP: "top", navVisa: "pas", navStore: "butik",
    ...
    navRanking: "ranking", navTOP: "suosituimmat", navVisa: "passi", navStore: "kauppa",
  ...
  no: { 
    ...
    navRanking: "rangering", navTOP: "topp", navVisa: "pass", navStore: "butikk",
  ...
  zh: { 
    ...
    navRanking: "排行榜", navTOP: "热门", navVisa: "护照", navStore: "商店",
  ...
  ja: { 
    ...
    navRanking: "ランキング", navTOP: "トップ", navVisa: "パスポート", navStore: "ストア",
  ...
  ko: { 
    ...
    navRanking: "랭킹", navTOP: "인기", navVisa: "여권", navStore: "상점",
  ...
  ar: { 
    ...
    navRanking: "ترتيب", navTOP: "أفضل", navVisa: "جواز سفر", navStore: "متجر",
  ...
  hi: { 
    ...
    navRanking: "रैंकिंग", navTOP: "टॉप", navVisa: "पासपोर्ट", navStore: "स्टोर",
  ...
  th: { 
    ...
    navRanking: "อันดับ", navTOP: "ยอดนิยม", navVisa: "พาสปอร์ต", navStore: "ร้านค้า",
  ...
  vi: { 
    ...
    navRanking: "xếp hạng", navTOP: "top", navVisa: "hộ chiếu", navStore: "cửa hàng",
  ...
  ca: { 
    ...
    navRanking: "classificació", navTOP: "destacats", navVisa: "passaport", navStore: "botiga",
  ...
  eu: { 
    ...
    navRanking: "sailkapena", navTOP: "nabarmenduak", navVisa: "pasaportea", navStore: "denda",
  ...
  tr: { 
    ...
    navRanking: "sıralama", navTOP: "öne çıkanlar", navVisa: "pasaport", navStore: "mağaza",
