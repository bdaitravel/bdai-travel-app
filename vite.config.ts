...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      '__GEMINI_API_KEY__': JSON.stringify(process.env.GEMINI_API_KEY || env.GEMINI_API_KEY || env.VITE_GEMINI_API_KEY_02 || env.VITE_GEMINI_API_KEY || ""),
      ...
      'process.env.API_KEY': JSON.stringify(process.env.GEMINI_API_KEY || env.GEMINI_API_KEY || env.VITE_GEMINI_API_KEY_02 || env.VITE_GEMINI_API_KEY || ""),
      'process.env.GEMINI_API_KEY': JSON.stringify(process.env.GEMINI_API_KEY || env.GEMINI_API_KEY || env.VITE_GEMINI_API_KEY_02 || env.VITE_GEMINI_API_KEY || ""),
