...
const MODAL_TEXTS: any = {
    ...
    pt: { title: "Passaporte Global bdai", subtitle: "Credencial Nômade Digital", surname: "Sobrenome", givenNames: "Nomes", city: "Cidade de Origem", country: "País", birthday: "Data de Nasc.", age: "Idade", social: "Social Matrix", interests: "Perfil de Intereses", visas: "Vistos Verificados", entry: "ENTRADA", verified: "VERIFICADO", noVisas: "Pronto para selos", save: "Salvar Passaporte", edit: "Editar Identidade", logout: "Sair", username: "Usuário", audioMemory: "Ouvir Memória", linked: "Vinculado", language: "Idioma Actual", rank: "Nível", miles: "Milhas Totais" },
    ...
    hi: { title: "bdai वैश्विक पासपोर्ट", subtitle: "डिजिटल घुमंतू क्रेडेंशियल", surname: "कुलनाम", givenNames: "नाम", city: "मूल शहर", country: "देश", birthday: "जन्म तिथि", age: "आयु", social: "सोशल मैट्रिक्स", interests: "रुचि प्रोफ़ाइल", visas: "सत्यापित वीज़ा", entry: "प्रवेश", verified: "सत्यापित", noVisas: "टिकटों के लिए तैयार", save: "पासポート सहेजें", edit: "पहचान संपादित करें", logout: "लॉग आउट", username: "उपयोगकर्ता नाम", audioMemory: "स्मृति सुनें", linked: "जुड़े हुए", language: "वर्तमान भाषा", rank: "रैंक", miles: "कुल मील" },
...
export const ProfileModal: React.FC<ProfileModalProps> = ({ user, onClose, isOwnProfile, onUpdateUser, onLogout, onOpenAdmin }) => {
  ...
  const handlePlayCityAudio = async (city: string) => {
      ...
      try {
          ...
          // Fix: Removed 3rd argument (city) from generateAudio call as it expects only (text, language)
