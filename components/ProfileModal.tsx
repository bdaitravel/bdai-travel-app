...
const UI_TEXT: any = {
    ...
    ca: { passport: "Passaport", surname: "Cognoms", givenNames: "Noms", rank: "Rang", miles: "Milles Totals", bio: "Biografia", badges: "Insignies", stamps: "Segells Visa", edit: "Editar", save: "Desar", langLabel: "Idioma", username: "Usuari", expedition: "Data Expedició", passportNo: "Núm. Passaport", socials: "Xarxes Socials", nextBadge: "Següent Fita", albumTitle: "Àlbum de Viatge IA", albumSub: "Generat de les teves últimes aventures", community: "Info Comunitat" },
    fr: { passport: "Passeport", surname: "Nom", givenNames: "Prénoms", rank: "Rang", miles: "Miles Totaux", bio: "Bio", badges: "Badges", stamps: "Tampons Visa", edit: "Modifier", save: "Enregistrer", langLabel: "Langue", username: "Utilisateur", expedition: "Date d'émission", passportNo: "N° Passeport", socials: "Réseaux Sociaux", nextBadge: "Prochain Objectif", albumTitle: "Album de Voyage IA", albumSub: "Généré à partir de vos aventures", community: "Infos Communauté" },
    de: { passport: "Reisepass", surname: "Nachname", givenNames: "Vornamen", rank: "Rang", miles: "Gesamtmeilen", bio: "Bio", badges: "Abzeichen", stamps: "Visastempel", edit: "Bearbeiten", save: "Speichern", langLabel: "Sprache", username: "Benutzername", expedition: "Ausstellungsdatum", passportNo: "Pass-Nr.", socials: "Soziale Netzwerke", nextBadge: "Nächster Meilenstein", albumTitle: "KI-Reisealbum", albumSub: "Erstellt aus deinen Abenteuern", community: "Community-Info" },
    pt: { passport: "Passaporte", surname: "Apelidos", givenNames: "Nomes", rank: "Classificação", miles: "Milhas Totais", bio: "Bio", badges: "Distintivos", stamps: "Selos de Visto", edit: "Editar", save: "Salvar", langLabel: "Idioma", username: "Utilizador", expedition: "Data de Emissão", passportNo: "Nº Passaporte", socials: "Redes Sociais", nextBadge: "Próxima Meta", albumTitle: "Álbum de Viagem IA", albumSub: "Gerado das tuas aventuras", community: "Info Comunidade" },
    ar: { passport: "جواز سفر", surname: "اللقب", givenNames: "الأسماء الأولى", rank: "الرتبة", miles: "إجمالي الأميال", bio: "السيرة الذاتية", badges: "الأوسمة", stamps: "أختام التأشيرة", edit: "تعديل", save: "حفظ", langLabel: "اللغة", username: "اسم المستخدم", expedition: "تاريخ الإصدار", passportNo: "رقم الجواز", socials: "التواصل الاجتماعي", nextBadge: "المعلم التالي", albumTitle: "ألبوم سفر الذكاء الاصطناعي", albumSub: "تم إنشاؤه من مغامراتك الأخيرة", community: "معلومات المجتمع" },
    zh: { passport: "护照", surname: "姓", givenNames: "名", rank: "等级", miles: "总里程", bio: "简介", badges: "勋章", stamps: "签证印章", edit: "编辑", save: "保存", langLabel: "语言", username: "用户名", expedition: "签发日期", passportNo: "护照号码", socials: "社交网络", nextBadge: "下一个里程碑", albumTitle: "AI 旅行相册", albumSub: "根据您的冒险自动生成", community: "社区信息" },
    ja: { passport: "パスポート", surname: "姓", givenNames: "名", rank: "ランク", miles: "通算マイル", bio: "自己紹介", badges: "バッジ", stamps: "入国スタンプ", edit: "編集", save: "保存", langLabel: "言語", username: "ユーザー名", expedition: "発行日", passportNo: "旅券番号", socials: "SNS", nextBadge: "次のマイルストーン", albumTitle: "AIトラベルアルバム", albumSub: "あなたの冒険から生成されました", community: "コミュニティ情報" }
};
...
export const ProfileModal: React.FC<ProfileModalProps> = ({ user, onClose, isOwnProfile, onUpdateUser, language = 'es' }) => {
  ...
  const handleSave = () => {
      if (onUpdateUser) {
          onUpdateUser({ ...profile, ...formData, rank: currentRank });
      }
      setIsEditing(false);
  };
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar bg-[#e8e4d8] m-3 rounded-[1.5rem] shadow-inner text-slate-900 pb-10 relative">
                ...
                <div className="p-6">
                        ...
                        <div className="flex-1 space-y-4 pt-1">
                            {isEditing ? (
                                ...
                                <>
                                    ...
                                    <div className="pt-2"><span className={`px-2 py-1 rounded bg-gradient-to-r ${RANK_CONFIG[currentRank].color} text-white text-[8px] font-black uppercase tracking-widest shadow-md`}>{currentRank}</span></div>
                                </>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="mb-8 p-4 bg-white/40 rounded-2xl border border-slate-900/5 shadow-sm">
                        ...
                        <div className="w-full h-1.5 bg-slate-200 rounded-full overflow-hidden mb-3">
                            <div className={`h-full bg-gradient-to-r ${RANK_CONFIG[currentRank].color} transition-all duration-1000`} style={{ width: `${progress}%` }}></div>
                        </div>
                        <div className="flex justify-between">
                            <Benefit icon="fa-tag" label={`${RANK_CONFIG[currentRank].discount} OFF`} active={true} />
                            <Benefit icon="fa-book" label="Guías Excl." active={profile.miles >= 5000} />
                            <Benefit icon="fa-image" label="Wallpapers" active={profile.miles >= 15000} />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <div className="space-y-3">
                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{t.socials}</p>
                            <div className="flex gap-2">
                                <SocialIcon icon="fab fa-instagram" href={profile.socials?.instagram} active={!!profile.socials?.instagram} />
                                <SocialIcon icon="fab fa-tiktok" href={profile.socials?.tiktok} active={!!profile.socials?.tiktok} />
                                <SocialIcon icon="fab fa-x-twitter" href={profile.socials?.x} active={!!profile.socials?.x} />
                            </div>
                        </div>
                        <div className="text-right">
                            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">{t.expedition}</p>
                            <p className="text-[10px] font-bold text-slate-600 font-mono italic">{profile.joinDate || '2024-01-01'}</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white p-4 rounded-3xl shadow-lg border border-slate-200 transform -rotate-1">
                             ...
                             <div className="mt-4 flex justify-between items-center pt-4 border-t border-slate-100">
                                 ...
                                 <span className="text-[10px] text-slate-400 font-mono italic">24/05/2024</span>
                             </div>
                        </div>
                        <button className="w-full py-4 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl flex items-center justify-center gap-2">
                            <i className="fas fa-file-export"></i> Exportar Álbum para Redes
                        </button>
                    </div>
                </div>
            )}
            ...
            {activeTab === 'community' && (
                <div className="p-6 animate-fade-in space-y-6">
                    <header>
                        <h3 className="text-xl font-black text-slate-900 leading-tight">Muro del Explorador</h3>
                        <p className="text-xs text-slate-500 font-medium">Lo que dicen otros viajeros sobre tus destinos</p>
                    </header>
...
const DataBlock = ({ label, value, color = "text-slate-900" }: any) => (
    <div>
        ...
        <p className={`text-sm font-black uppercase tracking-tight font-mono ${color}`}>{value || '---'}</p>
    </div>
);
