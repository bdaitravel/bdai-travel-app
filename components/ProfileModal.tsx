...
const MODAL_TEXTS: any = {
    ...
    it: { title: "Passaporto Globale bdai", subtitle: "ID Nomade Digitale", surname: "Cognome", givenNames: "Nome", city: "Città", country: "Paese", age: "Età", birthday: "Data di Nascita", categoryPoints: "Attività Tecnica", save: "Salva", edit: "Modifica", logout: "Logout", stamps: "Visti di Frontiera", visibility: "Visibilità", public: "Profilo Pubblico", private: "Profilo Privato" },
    ...
    fr: { title: "Passeport Global bdai", subtitle: "ID Nomade Numérique", surname: "Nom", givenNames: "Prénoms", city: "Ville", country: "Pays", age: "Âge", birthday: "Date de Naissance", categoryPoints: "Activité Technique", save: "Sauvegarder", edit: "Modifier", logout: "Déconnexion", stamps: "Visas de Frontière", visibility: "Visibilité", public: "Profil Public", private: "Profil Privé" },
    de: { title: "bdai Globaler Reisepass", subtitle: "Digitale Nomaden ID", surname: "Nachname", givenNames: "Vorname", city: "Stadt", country: "Land", age: "Alter", birthday: "Geburtsdatum", categoryPoints: "Technische Aktivität", save: "Speichern", edit: "Bearbeiten", logout: "Abmelden", stamps: "Grenzvisa", visibility: "Sichtbarkeit", public: "Öffentliches Profil", private: "Privates Profil" },
    ...
    ru: { title: "Глобальный паспорт bdai", subtitle: "ID цифрового кочевника", surname: "Фамилия", givenNames: "Имя", city: "Город", country: "Страна", age: "Возраст", birthday: "Дата рождения", categoryPoints: "Техническая активность", save: "Сохранить", edit: "Изменить", logout: "Выйти", stamps: "Пограничные визы", visibility: "Видимость", public: "Публичный профиль", private: "Приватный профиль" },
      ...
      <div className="bg-[#f3f0e6] w-full max-w-sm rounded-[2.5rem] overflow-hidden shadow-2xl relative z-10 border-[3px] border-[#d7d2c3] flex flex-col max-h-[95vh] text-slate-900">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar p-6 space-y-6">
            ...
            <div className="pt-5 border-t border-slate-300">
                <p className="text-[8px] font-black text-slate-400 uppercase mb-4 tracking-widest">Language</p>
