    ...
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-start overflow-y-auto no-scrollbar bg-slate-950/98 backdrop-blur-2xl">
      <div className="w-full max-w-sm px-4 pt-12">
        <div className="flex justify-between items-center mb-6 w-full px-2">
            ...
            <button onClick={onClose} className="w-10 h-10 rounded-xl bg-white/10 text-white flex items-center justify-center border border-white/5 active:scale-90"><i className="fas fa-times"></i></button>
        </div>

        <div className="bg-[#f3f0e6] w-full rounded-[2.5rem] overflow-hidden shadow-2xl relative border-[3px] border-[#d7d2c3] flex flex-col text-slate-900 mb-48">
                ...
                <div className="pt-6 border-t-2 border-dashed border-slate-300">
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        {user.stamps.length > 0 ? user.stamps.map((s, i) => (
                            <div key={i} className="aspect-square bg-white border-2 border-slate-300 rounded-2xl flex flex-col items-center justify-center p-1.5 shadow-sm transform rotate-3 hover:rotate-0 transition-transform">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {user.badges.length > 0 ? user.badges.map((b, i) => (
                            <div key={i} className="bg-purple-600/10 border border-purple-500/20 p-2.5 rounded-xl flex items-center gap-3">
                                <div className="w-7 h-7 rounded-lg bg-purple-600 flex items-center justify-center text-white shrink-0 shadow-lg">
                            ...
                            <div className="col-span-2 py-4 bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 flex flex-col items-center justify-center opacity-40">
                                <i className="fas fa-lock text-slate-300 mb-2"></i>
                                <p className="text-[7px] font-black uppercase text-slate-400">Unlock at first tour</p>
                            </div>
                        )}
                    </div>
                </div>
