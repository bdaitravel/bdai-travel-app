...
export const HubDetailModal: React.FC<HubDetailModalProps> = ({ intel, isSaved, onClose, onSave, language }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-end justify-center px-4 pb-12">
      ...
      <div className="bg-slate-900 w-full max-w-lg max-h-[85vh] rounded-[3rem] overflow-hidden shadow-2xl relative z-10 border border-white/10 flex flex-col animate-slide-up">
        <div className={`h-3 bg-gradient-to-r ${intel.color} shrink-0`}></div>
