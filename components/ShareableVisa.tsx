      ...
      if (navigator.canShare && navigator.canShare({ files: [file] })) {
        try {
          await navigator.share({
            ...
            text: `Mission Accomplished in ${cityName} with bdai.travel! 🌍✨ #bdai #travel`,
          });
          ...
          if (shareError.name === 'AbortError') {
            ...
            toast("📸 ¡Visado guardado! Abre Instagram para compartirlo. ✨", "success");
            setStatusText('✅ READY TO SHARE');
          }
        }
      } else {
        triggerDownload(dataUrl, fileName);
        toast("📸 ¡Visado descargado! Compártelo en tus redes. ✨", "success");
        setStatusText('✅ READY TO SHARE');
      }
    } catch (error: any) {
      ...
      >
        ...
        <div className="relative z-10 flex justify-between items-end">
          ...
          <div className="w-20 h-20 rounded-full border-2 border-dashed border-purple-500/40 flex flex-col items-center justify-center p-2 transform rotate-12 bg-purple-500/10 shadow-inner">
            ...
            <span className="text-[5px] font-black text-purple-500/50 uppercase">BDAI_CORE</span>
          </div>
        </div>
