...
const UI_TEXTS: any = {
    ...
    pt: { placeholder: "Compartilhe uma dica...", boardTitle: "Inteligência Viajante", anonymous: "Explorador", postBtn: "Transmitir", members: "Viajantes ativos", loading: "Acessando...", loginToPost: "Faça login para postar", reply: "Responder", toxicAlert: "Conteúdo inadequado." },
    it: { placeholder: "Condividi un segreto...", boardTitle: "Intelligenza Viaggiante", anonymous: "Esploratore", postBtn: "Trasmetti", members: "Viaggiatori attivi", loading: "Accesso...", loginToPost: "Accedi per condividere", reply: "Rispondi", toxicAlert: "Contenuto non appropriato." },
    ru: { placeholder: "Поделитесь советом...", boardTitle: "Интеллект путешественника", anonymous: "Исследователь", postBtn: "Отправить", members: "Активные исследователи", loading: "Загрузка...", loginToPost: "Войдите, чтобы поделиться", reply: "Ответить", toxicAlert: "Недопустимый контент." },
    hi: { placeholder: "एक गुप्त टिप साझा करें...", boardTitle: "यात्री इंटेलिजेंस", anonymous: "खोजकर्ता", postBtn: "प्रेषित", members: "सक्रिय खोजकर्ता", loading: "इंटेल तक पहुँच रहे हैं...", loginToPost: "साझा करने के लिए लॉगिन करें", reply: "जवाब दें", toxicAlert: "अस्वीकृत: अनुपयुक्त सामग्री।" },
    ...
    ja: { placeholder: "秘密のチップを共有...", boardTitle: "旅行者の知恵", anonymous: "探検家", postBtn: "送信", members: "アクティブな旅行者", loading: "ロード中...", loginToPost: "ログインして共有", reply: "返信", toxicAlert: "不適切なコンテンツ。" },
    ...
    ca: { placeholder: "Comparteix un secret...", boardTitle: "Intel·ligència Viatgera", anonymous: "Explorador", postBtn: "Transmetre", members: "Exploradors actius", loading: "Accedint al mur...", loginToPost: "Inicia sessió per compartir", reply: "Respondre", toxicAlert: "Contingut no apte." },
