    ...
    return (
      <div className="fixed inset-0 bg-[#020617] flex flex-col items-center justify-center p-8 z-[99999]">
        ...
        <p className="text-slate-500 text-xs text-center max-w-xs mb-8 leading-relaxed">
          {lang === 'es'
            ? 'DAI ha chocado contra algo inesperado. Ya hemos registrado el fallo automáticamente.'
            : 'DAI hit something unexpected. The crash has been logged automatically.'}
        </p>
        <div className="flex gap-3">
          ...
          >
            ...
            {lang === 'es' ? 'Añadir detalles' : 'Add details'}
          </button>
        </div>
