...
export const CITY_TRANSLATIONS: Record<string, any> = {
  ...
  "johannesburg": { es: "Johannesburgo", en: "Johannesburg", fr: "Johannesbourg", de: "Johannesburg", it: "Johannesburg", pt: "Joanesburgo", ro: "Johannesburg", zh: "约翰内斯堡", ja: "ヨハネスブルグ", ru: "Йоханнесбург", ar: "جوهانسبرغ", hi: "जोहान्सबर्ग", ko: "요하네스버그", tr: "Johannesburg", pl: "Johannesburg", nl: "Johannesburg", ca: "Johannesburg", eu: "Johannesburg", vi: "Johannesburg", th: "โจฮันเนสเบิร์ก" },
  "addis ababa": { es: "Adís Abeba", en: "Addis Ababa", fr: "Addis-Abeba", de: "Addis Abeba", it: "Addis Abeba", pt: "Adis Abeba", ro: "Addis Abeba", zh: "亚的斯亚贝巴", ja: "アディスアベバ", ru: "Аддис-Абеба", ar: "أديس أبابا", hi: "अदीस अबाबा", ko: "아디스아바바", tr: "Addis Ababa", pl: "Addis Abeba", nl: "Addis Abeba", ca: "Addis Abeba", eu: "Addis Abeba", vi: "Addis Ababa", th: "แอดดิสอาบาบา" },
  "dakar": { es: "Dakar", en: "Dakar", fr: "Dakar", de: "Dakar", it: "Dakar", pt: "Dakar", ro: "Dakar", zh: "达喀尔", ja: "ダカール", ru: "Дакар", ar: "داكار", hi: "डकार", ko: "다카르", tr: "Dakar", pl: "Dakar", nl: "Dakar", ca: "Dakar", eu: "Dakar", vi: "Dakar", th: "ดาการ์" },
  "tunis": { es: "Túnez", en: "Tunis", fr: "Tunis", de: "Tunis", it: "Tunisi", pt: "Túnis", ro: "Tunis", zh: "突尼斯", ja: "チュニス", ru: "Тунис", ar: "تونس", hi: "ट्यूनिस", ko: "튜니스", tr: "Tunus", pl: "Tunis", nl: "Tunis", ca: "Tunis", eu: "Tunis", vi: "Tunis", th: "ตูนิส" },
  "algiers": { es: "Argel", en: "Algiers", fr: "Alger", de: "Algier", it: "Algeri", pt: "Argel", ro: "Alger", zh: "阿尔及尔", ja: "アルジェ", ru: "Алжир", ar: "الجزائر", hi: "अल्जीयर्स", ko: "알제", tr: "Cezayir", pl: "Algier", nl: "Algiers", ca: "Alger", eu: "Aljer", vi: "Algiers", th: "แอลเจียร์" },
  "accra": { es: "Acra", en: "Accra", fr: "Accra", de: "Accra", it: "Accra", pt: "Acra", ro: "Accra", zh: "阿克拉", ja: "アクラ", ru: "Аккра", ar: "أكرا", hi: "अकरा", ko: "아크라", tr: "Akra", pl: "Akra", nl: "Accra", ca: "Accra", eu: "Accra", vi: "Accra", th: "อักกรา" },
  ...
  "dar es salaam": { es: "Dar es Salaam", en: "Dar es Salaam", fr: "Dar es Salaam", de: "Daressalam", it: "Dar es Salaam", pt: "Dar es Salaam", ro: "Dar es Salaam", zh: "达累斯萨拉姆", ja: "ダルエスサラーム", ru: "Дар-эс-Салам", ar: "دار السلام", hi: "दार एस सलाम", ko: "다르에스살람", tr: "Darüsselam", pl: "Dar es Salaam", nl: "Dar es Salaam", ca: "Dar es Salaam", eu: "Dar es Salaam", vi: "Dar es Salaam", th: "ดาร์เอสซาลาม" },
  "alexandria": { es: "Alejandría", en: "Alexandria", fr: "Alexandrie", de: "Alexandria", it: "Alessandria", pt: "Alexandria", ro: "Alexandria", zh: "亚历山大", ja: "アレクサンドリア", ru: "Александрия", ar: "الإسكندرية", hi: "अलेक्जेंड्रिया", ko: "알렉산드리아", tr: "İskenderiye", pl: "Aleksandria", nl: "Alexandrië", ca: "Alexandria", eu: "Alexandria", vi: "Alexandria", th: "อเล็กซานเดรีย" },
  ...
  "brisbane": { es: "Brisbane", en: "Brisbane", fr: "Brisbane", de: "Brisbane", it: "Brisbane", pt: "Brisbane", ro: "Brisbane", zh: "布里斯班", ja: "ブリスベン", ru: "Брисбен", ar: "بريسبان", hi: "ब्रिस्बेन", ko: "브리즈번", tr: "Brisbane", pl: "Brisbane", nl: "Brisbane", ca: "Brisbane", eu: "Brisbane", vi: "Brisbane", th: "บริสเบน" },
  "adelaide": { es: "Adelaida", en: "Adelaide", fr: "Adélaïde", de: "Adelaide", it: "Adelaide", pt: "Adelaide", ro: "Adelaide", zh: "阿德莱德", ja: "アデレード", ru: "Аделаида", ar: "أديلايد", hi: "ए德莱德", ko: "애들레이드", tr: "Adelaide", pl: "Adelaide", nl: "Adelaide", ca: "Adelaida", eu: "Adelaide", vi: "Adelaide", th: "แอดิเลด" },
  "wellington": { es: "Wellington", en: "Wellington", fr: "Wellington", de: "Wellington", it: "Wellington", pt: "Wellington", ro: "Wellington", zh: "惠灵顿", ja: "ウェリントン", ru: "Веллингтон", ar: "ويلينغتون", hi: "वेलिंगटन", ko: "웰링턴", tr: "Wellington", pl: "Wellington", nl: "Wellington", ca: "Wellington", eu: "Wellington", vi: "Wellington", th: "เวลลิงตัน" },
  "christchurch": { es: "Christchurch", en: "Christchurch", fr: "Christchurch", de: "Christchurch", it: "Christchurch", pt: "Christchurch", ro: "Christchurch", zh: "克赖斯特彻奇", ja: "クライストチャーチ", ru: "Крайстчерч", ar: "كرايستشيرش", hi: "क्राइस्टचर्च", ko: "크라이스트처치", tr: "Christchurch", pl: "Christchurch", nl: "Christchurch", ca: "Christchurch", eu: "Christchurch", vi: "Christchurch", th: "ไคร์สต์เชิร์ช" },
  ...
  "port moresby": { es: "Puerto Moresby", en: "Port Moresby", fr: "Port Moresby", de: "Port Moresby", it: "Port Moresby", pt: "Porto Moresby", ro: "Port Moresby", zh: "莫尔兹比港", ja: "ポートモレスビー", ru: "Порт-Морсби", ar: "بورت مورسبي", hi: "पोर्ट मोरेस्बी", ko: "포트모르즈비", tr: "Port Moresby", pl: "Port Moresby", nl: "Port Moresby", ca: "Port Moresby", eu: "Port Moresby", vi: "Port Moresby", th: "พอร์ตมอร์สบี" }
};
...
export const COUNTRY_TRANSLATIONS: Record<string, any> = {
  ...
  "vietnam": { es: "Vietnam", en: "Vietnam", fr: "Vietnam", de: "Vietnam", it: "Vietnam", pt: "Vietname", ro: "Vietnam", zh: "越南", ja: "ベトナム", ru: "Вьетнам", ar: "فيتنام", hi: "वियतनाम", ko: "베트남", tr: "Vietnam", pl: "Wietnam", nl: "Vietnam", ca: "Vietnam", eu: "Vietnam", vi: "Việt Nam", th: "เวียดนาม" },
  ...
  "ethiopia": { es: "Etiopía", en: "Ethiopia", fr: "Éthiopie", de: "Äthiopien", it: "Etiopia", pt: "Etiópia", ro: "Etiopia", zh: "埃塞俄比亚", ja: "エチオピア", ru: "Эфиопия", ar: "إثيوبيا", hi: "इथियोपिया", ko: "에티오피아", tr: "Etiyopya", pl: "Etiopia", nl: "Ethiopië", ca: "Etiòpia", eu: "Etiopia", vi: "Ethiopia", th: "เอธิโอเปีย" },
  ...
  "tunisia": { es: "Túnez", en: "Tunisia", fr: "Tunisie", de: "Tunesien", it: "Tunisia", pt: "Tunísia", ro: "Tunisia", zh: "突尼斯", ja: "チュニジア", ru: "Тунис", ar: "تونس", hi: "ट्यूनीशिया", ko: "튀니지", tr: "Tunus", pl: "Tunezja", nl: "Tunesië", ca: "Tunísia", eu: "Tunisia", vi: "Tunisia", th: "ตูนิเซีย" },
  "algeria": { es: "Argelia", en: "Algeria", fr: "Algérie", de: "Algerien", it: "Algeria", pt: "Argélia", ro: "Algeria", zh: "阿尔及利亚", ja: "アルジェリア", ru: "Алжир", ar: "الجزائر", hi: "अल्जीरिया", ko: "알제리", tr: "Cezayir", pl: "Algieria", nl: "Algerije", ca: "Algèria", eu: "Aljeria", vi: "Algeria", th: "แอลจีเรีย" },
  "ghana": { es: "Ghana", en: "Ghana", fr: "Ghana", de: "Ghana", it: "Ghana", pt: "Gana", ro: "Ghana", zh: "加纳", ja: "ガーナ", ru: "Гана", ar: "غانا", hi: "घाना", ko: "가나", tr: "Gana", pl: "Ghana", nl: "Ghana", ca: "Ghana", eu: "Ghana", vi: "Ghana", th: "กานา" },
  ...
  "tanzania": { es: "Tanzania", en: "Tanzania", fr: "Tanzanie", de: "Tansania", it: "Tanzania", pt: "Tanzânia", ro: "Tanzania", zh: "坦桑尼亚", ja: "タンザニア", ru: "Танзания", ar: "تنزانيا", hi: "तंजानिया", ko: "탄자니아", tr: "Tanzanya", pl: "Tanzania", nl: "Tanzania", ca: "Tanzània", eu: "Tanzania", vi: "Tanzania", th: "แทนซาเนีย" },
  "fiji": { es: "Fiyi", en: "Fiji", fr: "Fidji", de: "Fidschi", it: "Fiji", pt: "Fiji", ro: "Fiji", zh: "斐济", ja: "フィジー", ru: "Фиджи", ar: "فيجي", hi: "फिजी", ko: "피지", tr: "Fiji", pl: "Fidżi", nl: "Fiji", ca: "Fiji", eu: "Fiji", vi: "Fiji", th: "ฟิจิ" },
  "papua new guinea": { es: "Papúa Nueva Guinea", en: "Papua New Guinea", fr: "Papouasie-Nouvelle-Guinée", de: "Papua-Neuguinea", it: "Papua Nuova Guinea", pt: "Papua-Nova Guiné", ro: "Papua Noua Guinee", zh: "巴布亚新几内亚", ja: "パプアニューギニア", ru: "Папуа — Новая Гвинея", ar: "بابوا غينيا الجديدة", hi: "पापुआ न्यू गिनी", ko: "파푸아뉴기니", tr: "Papua Yeni Gine", pl: "Papua-Nowa Gwinea", nl: "Papoea-Nieuw-Guinea", ca: "Papua Nova Guinea", eu: "Papua Ginea Berria", vi: "Papua New Guinea", th: "ปาปัวนิวกินี" }
};
...
const CITY_NAME_MAP_RAW: Record<string, string> = {
  ...
  syd: "Sídney", mel: "Melbourne", akl: "Auckland", per: "Perth", bne: "Brisbane", adl: "Adelaide", wlg: "Wellington", chc: "Christchurch", suv: "Suva", pom: "Port Moresby",
  los: "Lagos", jnb: "Johannesburg", add: "Addis Ababa", dkr: "Dakar", tun: "Tunis", alg: "Algiers", acc: "Accra", lad: "Luanda", dar: "Dar es Salaam", alx: "Alexandria"
};
...
const WORLD_DATA = {
  ...
  africa: [{ cityKey: "cai", countryKey: "egypt" }, { cityKey: "cpt", countryKey: "south africa" }, { cityKey: "rak", countryKey: "morocco" }, { cityKey: "nbo", countryKey: "kenya" }, { cityKey: "cas", countryKey: "morocco" }, { cityKey: "los", countryKey: "nigeria" }, { cityKey: "jnb", countryKey: "south africa" }, { cityKey: "add", countryKey: "ethiopia" }, { cityKey: "dkr", countryKey: "senegal" }, { cityKey: "tun", countryKey: "tunisia" }, { cityKey: "alg", countryKey: "algeria" }, { cityKey: "acc", countryKey: "ghana" }, { cityKey: "lad", countryKey: "angola" }, { cityKey: "dar", countryKey: "tanzania" }, { cityKey: "alx", countryKey: "egypt" }],
  oceania: [{ cityKey: "syd", countryKey: "australia" }, { cityKey: "mel", countryKey: "australia" }, { cityKey: "akl", countryKey: "new zealand" }, { cityKey: "per", countryKey: "australia" }, { cityKey: "bne", countryKey: "australia" }, { cityKey: "adl", countryKey: "australia" }, { cityKey: "wlg", countryKey: "new zealand" }, { cityKey: "chc", countryKey: "new zealand" }, { cityKey: "suv", countryKey: "fiji" }, { cityKey: "pom", countryKey: "papua new guinea" }]
};
