...
const UI_LABELS: Record<string, any> = {
    ...
    fr: { 
        hubTitle: "Intel Hub", hubSub: "Base Mondiale", homeTitle: "Explorer l'Espagne", homeSub: "Masterclasses Nationales", 
    ...
    pt: { 
        ...
        countries: { esp: "Espanha", fra: "França", gbr: "Reino Unido", deu: "Alemanha", ita: "Itália", nld: "Países Baixos", cze: "Tchéquia", aut: "Áustria", grc: "Grécia", prt: "Portugal", hun: "Hungria", usa: "EUA", mex: "México", arg: "Argentina", bra: "Brasil", col: "Colômbia", per: "Peru", chl: "Chile", can: "Canadá", jpn: "Japão", kor: "Coreia do Sul", tha: "Tailândia", chn: "China", sgp: "Singapura", are: "EAU", ind: "Índia", tur: "Turquia", vnm: "Vietname", mar: "Marrocos", egy: "Egito", zaf: "África do Sudté", ken: "Quénia", tun: "Tunísia", nga: "Nigéria", sen: "Senegal", aus: "Austrália", nzl: "Nova Zelândia" },
    ...
    zh: { 
        ...
        cities: { mad: "马德里", bcn: "巴塞罗那", vlc: "瓦伦西亚", svq: "塞维利亚", grx: "格拉纳达", agp: "马拉加", pmi: "帕尔马", bio: "毕尔巴鄂", ron: "龙达", cad: "卡达克斯", alb: "阿尔瓦拉辛", cud: "库迪列罗", ter: "特鲁埃尔", sor: "索里亚", ube: "乌韦达", cac: "卡塞雷斯", par: "巴黎", lon: "伦敦", ber: "柏林", rom: "罗马", ams: "阿姆斯特丹", prg: "布拉格", vie: "维也纳", ath: "雅典", lis: "里斯本", bud: "布达佩斯", nyc: "纽约", mex: "墨西哥城", bue: "布宜诺斯艾利斯", rio: "里约热内卢", bog: "波哥大", lim: "利马", scl: "圣地亚哥", yyz: "多伦多", chi: "芝加哥", sfo: "旧金山", tyo: "东京", sel: "首尔", bkk: "曼谷", pek: "北京", sin: "新加坡", dxb: "迪拜", bom: "孟买", ist: "イスタンブール", hkg: "香港", han: "河内", rak: "马拉喀什", cai: "开罗", cpt: "开普敦", nbo: "内罗毕", tun: "突尼斯市", cas: "卡萨布兰卡", los: "拉各斯", dkr: "达迦马", syd: "悉尼", mel: "墨尔本", akl: "奥克兰", bne: "布里斯班", per: "珀斯", ool: "黄金海岸" }
    },
    ru: {
        hubTitle: "Интел-Хаб", hubSub: "Глобальная база данных", homeTitle: "Исследуйте Испанию", homeSub: "Национальные мастер-классы", 
        catCapitales: "Крупные столицы", catVisitadas: "Самые посещаемые", catPueblos: "Очаровательные деревни", catJoyas: "Скрытые сокровища",
...
export const TravelServices: React.FC<any> = ({ mode, language = 'es', onCitySelect }) => {
    // Detección de idioma con fallback inteligente a inglés si el idioma no está definido en el hub
    const l = UI_LABELS[language] || UI_LABELS.en;
    const [activeTab, setActiveTab] = useState<string>('europa');

    // Función auxiliar para obtener nombres de países/ciudades desde el diccionario local
