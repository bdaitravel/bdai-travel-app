...
export const CITY_TRANSLATIONS: Record<string, any> = {
  ...
  "seville": { es: "Sevilla", en: "Seville", fr: "Séville", de: "Sevilla", it: "Siviglia", pt: "Sevilha", ro: "Sevilia", zh: "塞维利亚", ja: "セビリア", ru: "Севилья", ar: "إشبيلية", hi: "सेविले", ko: "세비야", tr: "Sevilla", pl: "Sewilla", nl: "Sevilla", ca: "Sevilla", eu: "Sevilla", vi: "Sevilla", th: "เซบียา" },
  "sevilla": { es: "Sevilla", en: "Seville", fr: "Séville", de: "Sevilla", it: "Siviglia", pt: "Sevilha", ro: "Sevilia", zh: "塞维利亚", ja: "セビリア", ru: "Севилья", ar: "إشبيلية", hi: "सेविले", ko: "세비야", tr: "Sevilla", pl: "Sewilla", nl: "Sevilla", ca: "Sevilla", eu: "Sevilla", vi: "Sevilla", th: "เซบียา" },
  ...
  "cadiz": { es: "Cádiz", en: "Cadiz", fr: "Cadix", de: "Cadiz", it: "Cadice", pt: "Cádiz", ro: "Cadiz", zh: "加的斯", ja: "カディス", ru: "Кадис", ar: "قادس", hi: "काडिज", ko: "카디스", tr: "Cádiz", pl: "Kadyks", nl: "Cadiz", ca: "Cadis", eu: "Cadiz", vi: "Cádiz", th: "กาดิซ" },
  ...
  "buenos aires": { es: "Buenos Aires", en: "Buenos Aires", fr: "Buenos Aires", de: "Buenos Aires", it: "Buenos Aires", pt: "Buenos Aires", ro: "Buenos Aires", zh: "布宜诺斯艾利斯", ja: "ブエノスアイレス", ru: "Буэнос-Айрес", ar: "بوينس آيرس", hi: "ब्यूनस आयर्स", ko: "부에노스아이레스", tr: "Buenos Aires", pl: "Buenos Aires", nl: "Buenos Aires", ca: "Buenos Aires", eu: "Buenos Aires", vi: "Buenos Aires", th: "บัวโนสไอเรส" },
  ...
  "santiago": { es: "Santiago", en: "Santiago", fr: "Santiago", de: "Santiago", it: "Santiago", pt: "Santiago", ro: "Santiago", zh: "圣地亚哥", ja: "サンティアゴ", ru: "Сантьяго", ar: "سانتياغو", hi: "सैंटियागो", ko: "산티아고", tr: "Santiago", pl: "Santiago", nl: "Santiago", ca: "Santiago", eu: "Santiago", vi: "Santiago", th: "ซานติาโก" },
...
export const COUNTRY_TRANSLATIONS: Record<string, any> = {
  ...
  "morocco": { es: "Marruecos", en: "Morocco", fr: "Maroc", de: "Marokko", it: "Marocco", pt: "Marrocos", ro: "Maroc", zh: "摩洛哥", ja: "モロッコ", ru: "Марокко", ar: "المغرب", hi: "मोरक्को", ko: "모로코", tr: "Fas", pl: "Maroko", nl: "Marokko", ca: "Marroc", eu: "Maroko", vi: "Ma-rốc", th: "โมร็อกโก" },
  ...
  "chile": { es: "Chile", en: "Chile", fr: "Chili", de: "Chile", it: "Cile", pt: "Chile", ro: "Chile", zh: "智利", ja: "チリ", ru: "Чили", ar: "تشيلي", hi: "चिली", ko: "칠레", tr: "Şili", pl: "Chile", nl: "Chili", ca: "Xile", eu: "Txile", vi: "Chi-lê", th: "ชิลี" },
...
const CITY_NAME_MAP_RAW: Record<string, string> = {
  ...
  syd: "Sydney", mel: "Melbourne", akl: "Auckland", per: "Perth", suv: "Suva", ool: "Gold Coast"
};
...
// ✅ FIX: CityMiniCard now correctly passes rawName and countryKey to onSelect
const CityMiniCard: React.FC<{
  rawName: string;
  lang: string;
  countryKey: string;
  onSelect: (name: string, country: string) => void;
  colorIdx: number;
}> = ({ rawName, lang, countryKey, onSelect, colorIdx }) => {
  ...
  return (
    <div
      onClick={() => onSelect(rawName, countryKey)}  // ✅ FIX: was () => onSelect(...) ignoring params
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            {SPAIN_DATA.visitadas.map((city, i) => (
              <CityMiniCard key={city.cityKey} rawName={CITY_NAME_MAP_RAW[city.cityKey]} lang={lang} countryKey="spain" onSelect={handleCitySelection} colorIdx={i + 4} />
            ))}
          </div>
        </section>
        <section className="space-y-4">
