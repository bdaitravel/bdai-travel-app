...
const UI_LABELS: Record<string, any> = {
    ...
    en: { 
        ...
        catCapitales: "Big Capitals", catVisitadas: "Most Visitated", catPueblos: "Charming Towns", catJoyas: "Hidden Gems",
    ...
    eu: { 
        hubTitle: "Intel Hub", hubSub: "Datu-base Globala", homeTitle: "Espainia Arakatu", homeSub: "Masterclasses Nacionalak", 
    ...
    fr: { 
        hubTitle: "Intel Hub", hubSub: "Base de Données Globale", homeTitle: "Explorer l'Espagne", homeSub: "Masterclasses Nationales", 
        catCapitales: "Grandes Capitales", catVisitadas: "Les Plus Visitées", catPueblos: "Villages de Charme", catJoyas: "Joyaux Cachés",
        catEuropa: "Europe", catAmerica: "Amérique", catAsia: "Asie", catAfrica: "Afrique", catOceania: "Océanie",
        countries: { esp: "Espagne", fra: "France", gbr: "Royaume-Uni", deu: "Allemagne", ita: "Italie", nld: "Pays-Bas", cze: "Tchéquie", aut: "Autriche", grc: "Grèce", prt: "Portugal", hun: "Hongrie", usa: "USA", mex: "Mexique", arg: "Argentine", bra: "Brésil", col: "Colombie", per: "Pérou", chl: "Chili", can: "Canada", jpn: "Japon", kor: "Corée du Sud", tha: "Thaïlande", chn: "Chine", sgp: "Singapour", are: "EAU", ind: "Inde", tur: "Turquie", vnm: "Vietnam", mar: "Maroc", egy: "Égypte", zaf: "Afrique du Sud", ken: "Kenya", tun: "Tunisie", nga: "Nigéria", sen: "Sénégal", aus: "Australie", nzl: "Nouvelle-Zélande" },
        cities: { mad: "Madrid", bcn: "Barcelone", vlc: "Valence", svq: "Séville", grx: "Grenade", agp: "Malaga", pmi: "Palma", bio: "Bilbao", ron: "Ronda", cad: "Cadaqués", alb: "Albarracín", cud: "Cudillero", ter: "Teruel", sor: "Soria", ube: "Úbeda", cac: "Cáceres", par: "Paris", lon: "Londres", ber: "Berlin", rom: "Rome", ams: "Amsterdam", prg: "Prague", vie: "Vienne", ath: "Athènes", lis: "Lisbonne", bud: "Budapest", nyc: "New York", mex: "Mexico", bue: "Buenos Aires", rio: "Rio de Janeiro", bog: "Bogotá", lim: "Lima", scl: "Santiago", yyz: "Toronto", chi: "Chicago", sfo: "San Francisco", tyo: "Tokyo", sel: "Séoul", bkk: "Bangkok", pek: "Pékin", sin: "Singapour", dxb: "Dubaï", bom: "Mumbai", ist: "Istanbul", hkg: "Hong Kong", han: "Hanoï", rak: "Marrakech", cai: "Le Caire", cpt: "Le Cap", nbo: "Nairobi", tun: "Tunis", cas: "Casablanca", los: "Lagos", dkr: "Dakar", syd: "Sydney", mel: "Melbourne", akl: "Auckland", bne: "Brisbane", per: "Perth", ool: "Gold Coast" }
    },
    de: { 
        hubTitle: "Intel Hub", hubSub: "Globale Datenbank", homeTitle: "Spanien Erkunden", homeSub: "Nationale Masterclasses", 
        catCapitales: "Hauptstädte", catVisitadas: "Am Meisten Besucht", catPueblos: "Charmante Dörfer", catJoyas: "Verborgene Schätze",
        catEuropa: "Europa", catAmerica: "Amerika", catAsia: "Asien", catAfrica: "Afrika", catOceania: "Ozeanien",
        countries: { esp: "Spanien", fra: "Frankreich", gbr: "GB", deu: "Deutschland", ita: "Italien", nld: "Niederlande", cze: "Tschechien", aut: "Österreich", grc: "Griechenland", prt: "Portugal", hun: "Ungarn", usa: "USA", mex: "Mexiko", arg: "Argentinien", bra: "Brasilien", col: "Kolumbien", per: "Peru", chl: "Chile", can: "Kanada", jpn: "Japan", kor: "Südkorea", tha: "Thailand", chn: "China", sgp: "Singapur", are: "VAE", ind: "Indien", tur: "Türkei", vnm: "Vietnam", mar: "Marokko", egy: "Ägypten", zaf: "Südafrika", ken: "Kenia", tun: "Tunesien", nga: "Nigeria", sen: "Senegal", aus: "Australien", nzl: "Neuseeland" },
    ...
    pt: { 
        hubTitle: "Intel Hub", hubSub: "Base Global", homeTitle: "Explorar Espanha", homeSub: "Masterclasses Nacionais", 
        catCapitales: "Capitais", catVisitadas: "Mais Visitadas", catPueblos: "Vilas Charmosas", catJoyas: "Joias Escondidas",
        ...
        cities: { mad: "Madrid", bcn: "Barcelona", vlc: "Valencia", svq: "Sevilha", grx: "Granada", agp: "Málaga", pmi: "Palma", bio: "Bilbau", ron: "Ronda", cad: "Cadaqués", alb: "Albarracín", cud: "Cudillero", ter: "Teruel", sor: "Soria", ube: "Úbeda", cac: "Cáceres", par: "Paris", lon: "Londres", ber: "Berlim", rom: "Roma", ams: "Amesterdão", prg: "Praga", vie: "Viena", ath: "Atenas", lis: "Lisboa", bud: "Budapeste", nyc: "Nova Iorque", mex: "Cidade do México", bue: "Buenos Aires", rio: "Rio de Janeiro", bog: "Bogotá", lim: "Lima", scl: "Santiago", yyz: "Toronto", chi: "Chicago", sfo: "São Francisco", tyo: "Tóquio", sel: "Seul", bkk: "Banguecoque", pek: "Pequim", sin: "Singapura", dxb: "Dubai", bom: "Mumbai", ist: "Istambul", hkg: "Hong Kong", han: "Hanói", rak: "Marraquexe", cai: "Cairo", cpt: "Cidade do Cabo", nbo: "Nairobi", tun: "Tunes", cas: "Casablanca", los: "Lagos", dkr: "Dacar", syd: "Sydney", mel: "Melbourne", akl: "Auckland", bne: "Brisbane", per: "Perth", ool: "Gold Coast" }
    },
    ja: { 
    ...
    ru: { 
        hubTitle: "Инфо Хаб", hubSub: "Мировая база", homeTitle: "Исследуй Испанию", homeSub: "Мастер-классы", 
        catCapitales: "Столицы", catVisitadas: "Популярные", catPueblos: "Деревни", catJoyas: "Сокровища",
    ...
    ar: { 
        ...
        catCapitales: "عواصم كبرى", catVisitadas: "الأكثر زيارة", catPueblos: "قرى ساحرة", catJoyas: "كنوز خفية",
        catEuropa: "أوروبا", catAmerica: "أمريكا", catAsia: "آسيا", catAfrica: "أفريقيا", catOceania: "أوقيانوسيا",
        countries: { esp: "إسبانيا", fra: "فرنسا", gbr: "بريطانيا", deu: "ألمانيا", ita: "إيطاليا", nld: "هولندا", cze: "تشيكيا", aut: "النمسا", grc: "اليونان", prt: "البرتغال", hun: "المجر", usa: "أمريكا", mex: "المكسيك", arg: "الأرجنتين", bra: "البرازيل", col: "كولومبيا", per: "بيرو", chl: "تشيلي", can: "كندا", jpn: "اليابان", kor: "كوريا", tha: "تايلاند", chn: "الصين", sgp: "سنغافورة", are: "الإمارات", ind: "الهند", tur: "تركيا", vnm: "فيتنام", mar: "المغرب", egy: "مصر", zaf: "جنوب أفريقيا", ken: "كينيا", tun: "تونس", nga: "نيجيريا", sen: "السنغال", aus: "أستراليا", nzl: "نيوزيلندا" },
        cities: { mad: "مدريد", bcn: "برشلونة", vlc: "فالنسيا", svq: "إشبيلية", grx: "غرناطة", agp: "مالقة", pmi: "بالما", bio: "بلباو", ron: "روندا", cad: "كاداكيس", alb: "البراسين", cud: "كوديرو", ter: "تيرويل", sor: "سوريا", ube: "أوبيدا", cac: "كاسيريس", par: "باريس", lon: "لندن", ber: "برلين", rom: "روما", ams: "أمستردام", prg: "براغ", vie: "فيينا", ath: "أثينا", lis: "لشبونة", bud: "بودابست", nyc: "نيويورك", mex: "مكسيكو سيتي", bue: "بوينس آيرس", rio: "ريو دي جانيرو", bog: "بوغوتا", lim: "ليما", scl: "سانتياغو", yyz: "تورونتو", chi: "شيكاغو", sfo: "سان فرانسيسكو", tyo: "طوكيو", sel: "سيول", bkk: "بانكوك", pek: "بكين", sin: "سنغافورة", dxb: "دبي", bom: "مومباي", ist: "اسطنبول", hkg: "هونغ كونغ", han: "هانوي", rak: "مراكش", cai: "القاهرة", cpt: "كيب تاون", nbo: "نيروبي", tun: "تونس", cas: "الدار البيضاء", los: "لاغوس", dkr: "داكار", syd: "سيدني", mel: "ملبورن", akl: "أوكلاند", bne: "بريزبان", per: "بيرث", ool: "غولد كوست" }
    },
    hi: { 
        hubTitle: "इंटेल हब", hubSub: "वैश्विक डेटाबेस", homeTitle: "स्पेन का अन्वेषण", homeSub: "मास्टरक्लास", 
        catCapitales: "प्रमुख राजधानियाँ", catVisitadas: "सबसे अधिक देखी गई", catPueblos: "आकर्षक गाँव", catJoyas: "छिपे हुए रत्न",
        catEuropa: "यूरोप", catAmerica: "अमेरिका", catAsia: "एशिया", catAfrica: "अफ्रीका", catOceania: "ओशिनिया",
        countries: { esp: "स्पेन", fra: "फ्रांस", gbr: "ब्रिटेन", deu: "जर्मनी", ita: "इटली", nld: "नीदरलैंड", cze: "चेकिया", aut: "ऑस्ट्रिया", grc: "ग्रीस", prt: "पुर्तगाल", hun: "हंगरी", usa: "यूएसए", mex: "मेक्सिको", arg: "अर्जेंटीना", bra: "ब्राजील", col: "कोलंबिया", per: "पेरू", chl: "चिली", can: "कनाडा", jpn: "जापान", kor: "कोरिया", tha: "थाईलैंड", chn: "चीन", sgp: "सिंगापुर", are: "यूएई", ind: "भारत", tur: "तुर्की", vnm: "वियतनाम", mar: "मोरक्को", egy: "मिस्र", zaf: "दक्षिण अफ्रीका", ken: "केन्या", tun: "ट्यूनीशिया", nga: "नाइजीरिया", sen: "सेनेगल", aus: "ऑस्ट्रेलिया", nzl: "न्यूजीलैंड" },
        cities: { mad: "मैड्रिड", bcn: "बार्सिलोना", vlc: "वालेंसिया", svq: "सेविले", grx: "ग्रानाडा", agp: "मालागा", pmi: "पालमा", bio: "बिल्बाओ", ron: "रोंडा", cad: "काडाक्वेस", alb: "अल्बारासिन", cud: "कुडिलेरो", ter: "टेरुल", sor: "सोरिया", ube: "उबेदा", cac: "कासेरेस", par: "पेरिस", lon: "लंदन", ber: "बर्लिन", rom: "रोम", ams: "एम्स्टर्डम", prg: "प्राग", vie: "वियना", ath: "एथेंस", lis: "लिस्बन", bud: "बुडापेस्ट", nyc: "न्यूयॉर्क", mex: "मेक्सिको सिटी", bue: "ब्यूनस आयर्स", rio: "रियो डी जनेरियो", bog: "बोगोटा", lim: "लीमा", scl: "मैड्रिड", yyz: "टोरंटो", chi: "शिकागो", sfo: "सैन फ्रांसिस्को", tyo: "टोक्यो", sel: "सियोल", bkk: "बैंकॉक", pek: "बीजिंग", sin: "सिंगापुर", dxb: "दुबई", bom: "मुंबई", ist: "इस्तांबुल", hkg: "हांगकांग", han: "हनोई", rak: "माराकेच", cai: "काहिरा", cpt: "केप टाउन", nbo: "नैरोबी", tun: "ट्यूनिस", cas: "कासाब्लांका", los: "लागोस", dkr: "डकार", syd: "सिडनी", mel: "मेलबर्न", akl: "ऑकलैंड", bne: "ब्रिस्बेन", per: "पर्थ", ool: "गोल्ड कोस्ट" }
    },
    ko: { 
        hubTitle: "인텔 허브", hubSub: "글로벌 데이터베이스", homeTitle: "스페인 탐험", homeSub: "마스터클래스", 
        catCapitales: "주요 수도", catVisitadas: "가장 많이 방문한", catPueblos: "매력적인 마을", catJoyas: "숨겨진 보석",
        catEuropa: "유럽", catAmerica: "아메리카", catAsia: "아시아", catAfrica: "아프리카", catOceania: "오세아니아",
        countries: { esp: "스페인", fra: "프랑스", gbr: "영국", deu: "독일", ita: "이탈리아", nld: "네덜란드", cze: "체코", aut: "오스트리아", grc: "그리스", prt: "포르투갈", hun: "헝가리", usa: "미국", mex: "멕시코", arg: "아르헨티나", bra: "브라질", col: "콜롬비아", per: "페루", chl: "칠레", can: "캐나다", jpn: "일본", kor: "한국", tha: "태국", chn: "중국", sgp: "싱가포르", are: "UAE", ind: "인도", tur: "터키", vnm: "베트남", mar: "모로코", egy: "이집트", zaf: "남아공", ken: "케냐", tun: "튀니지", nga: "나이지리아", sen: "세네갈", aus: "호주", nzl: "뉴질랜드" },
        cities: { mad: "마드리드", bcn: "바르셀로나", vlc: "발렌시아", svq: "세비야", grx: "그라나다", agp: "말라가", pmi: "팔마", bio: "빌바오", ron: "RONDA", cad: "카다케스", alb: "알바라신", cud: "쿠디예로", ter: "테루엘", sor: "소리아", ube: "우베다", cac: "카세레스", par: "파리", lon: "런던", ber: "베를린", rom: "로마", ams: "암스테르담", prg: "프라하", vie: "비엔나", ath: "아테네", lis: "리스본", bud: "부다페스트", nyc: "뉴욕", mex: "멕시코시티", bue: "부에노스아이레스", rio: "리우데자네이루", bog: "보고타", lim: "리마", scl: "산티아고", yyz: "토론토", chi: "시카고", sfo: "샌프란시스코", tyo: "도쿄", sel: "서울", bkk: "방콕", pek: "베이징", sin: "싱가포르", dxb: "두바이", bom: "뭄바이", ist: "이스탄불", hkg: "홍콩", han: "하노이", rak: "마라케시", cai: "카이로", cpt: "케이프타운", nbo: "나이로비", tun: "튀니스", cas: "카사블랑카", los: "라고스", dkr: "다카르", syd: "시드니", mel: "멜버른", akl: "오클랜드", bne: "브리즈번", per: "퍼스", ool: "골드코스트" }
    },
    tr: { 
        hubTitle: "Bilgi Merkezi", hubSub: "Küresel Veritabanı", homeTitle: "İspanya'yı Keşfet", homeSub: "Masterclasslar", 
        catCapitales: "Büyük Başkentler", catVisitadas: "En Çok Ziyaret Edilen", catPueblos: "Büyüleyici Köyler", catJoyas: "Gizli Mücevherler",
        catEuropa: "Avrupa", catAmerica: "Amerika", catAsia: "Asya", catAfrica: "Afrika", catOceania: "Okyanusya",
        countries: { esp: "İspanya", fra: "Fransa", gbr: "İngiltere", deu: "Almanya", ita: "İtalya", nld: "Hollanda", cze: "Çekya", aut: "Avusturya", grc: "Yunanistan", prt: "Portekiz", hun: "Macaristan", usa: "ABD", mex: "Meksika", arg: "Arjantin", bra: "Brezilya", col: "Kolombiya", per: "Peru", chl: "Şili", can: "Kanada", jpn: "Japonya", kor: "Kore", tha: "Tayland", chn: "Çin", sgp: "Singapur", are: "BAE", ind: "Hindistan", tur: "Türkiye", vnm: "Vietnam", mar: "Fas", egy: "Mısır", zaf: "Güney Afrika", ken: "Kenya", tun: "Tunus", nga: "Nijerya", sen: "Senegal", aus: "Avustralya", nzl: "Yeni Zelanda" },
        cities: { mad: "Madrid", bcn: "Barselona", vlc: "Valensiya", svq: "Sevilla", grx: "Granada", agp: "Malaga", pmi: "Palma", bio: "Bilbao", ron: "Ronda", cad: "Cadaques", alb: "Albarracin", cud: "Cudillero", ter: "Teruel", sor: "Soria", ube: "Ubeda", cac: "Caceres", par: "Paris", lon: "Londra", ber: "Berlin", rom: "Roma", ams: "Amsterdam", prg: "Prag", vie: "Viyana", ath: "Atina", lis: "Lizbon", bud: "Budapeşte", nyc: "New York", mex: "Mexico City", bue: "Buenos Aires", rio: "Rio de Janeiro", bog: "Bogota", lim: "Lima", scl: "Santiago", yyz: "Toronto", chi: "Chicago", sfo: "San Francisco", tyo: "Tokyo", sel: "Seul", bkk: "Bangkok", pek: "Pekin", sin: "Singapur", dxb: "Dubai", bom: "Mumbai", ist: "İstanbul", hkg: "Hong Kong", han: "Hanoi", rak: "Marakeş", cai: "Kahire", cpt: "Cape Town", nbo: "Nairobi", tun: "Tunus", cas: "Kazablanka", los: "Lagos", dkr: "Dakar", syd: "Sidney", mel: "Melbourne", akl: "Auckland", bne: "Brisbane", per: "Perth", ool: "Gold Coast" }
    },
    pl: { 
        hubTitle: "Centrum Inteligentne", hubSub: "Baza Danych", homeTitle: "Odkryj Hiszpanię", homeSub: "Masterclassy", 
        catCapitales: "Wielkie Stolice", catVisitadas: "Najczęściej Odwiedzane", catPueblos: "Urokliwe Miasteczka", catJoyas: "Ukryte Klejnoty",
    ...
    vi: { 
        ...
        cities: { mad: "Madrid", bcn: "Barcelona", vlc: "Valencia", svq: "Seville", grx: "Granada", agp: "Malaga", pmi: "Palma", bio: "Bilbao", ron: "Ronda", cad: "Cadaques", alb: "Albarracin", cud: "Cudillero", ter: "Teruel", sor: "Soria", ube: "Ubeda", cac: "Caceres", par: "Paris", lon: "Luân Đôn", ber: "Berlin", rom: "Rome", ams: "Amsterdam", prg: "Prague", vie: "Vienna", ath: "Athens", lis: "Lisbon", bud: "Budapest", nyc: "New York", mex: "Thành phố Mexico", bue: "Buenos Aires", rio: "Rio de Janeiro", bog: "Bogota", lim: "Lima", scl: "Santiago", yyz: "Toronto", chi: "Chicago", sfo: "San Francisco", tyo: "Tokyo", sel: "Seoul", bkk: "Bangkok", pek: "Bắc Kinh", sin: "Singapore", dxb: "Dubai", bom: "Mumbai", ist: "Istanbul", hkg: "Hồng Kông", han: "Hà Nội", rak: "Marrakech", cai: "Cairo", cpt: "Cape Town", nbo: "Nairobi", tun: "Tunis", cas: "Casablanca", los: "Lagos", dkr: "Dakar", syd: "Sydney", mel: "Melbourne", akl: "Auckland", bne: "Brisbane", per: "Perth", ool: "Gold Coast" }
    },
    th: { 
        hubTitle: "ศูนย์กลางข้อมูล", hubSub: "ฐานข้อมูลระดับโลก", homeTitle: "สำรวจสเปน", homeSub: "มาสเตอร์คลาสระดับประเทศ", 
        catCapitales: "เมืองหลวงสำคัญ", catVisitadas: "ยอดนิยม", catPueblos: "เมืองที่มีเสน่ห์", catJoyas: "ขุมทรัพย์ที่ซ่อนอยู่",
        ...
        cities: { mad: "มาดริด", bcn: "บาร์เซโลนา", vlc: "บาเลนเซีย", svq: "เซบียา", grx: "กรานาดา", agp: "มาลากา", pmi: "ปัลมา", bio: "บิลบาโอ", ron: "รอนดา", cad: "กาดาเกส", alb: "อัลบาร์ราซิน", cud: "คูดิเยโร", ter: "เตรูเอล", sor: "โซเรีย", ube: "อูเบดา", cac: "กาเซเรส", par: "ปารีส", lon: "ลอนดอน", ber: "เบอร์ลิน", rom: "โรม", ams: "อัมสเตอร์ดัม", prg: "ปราก", vie: "เวียนนา", ath: "เอเธนส์", lis: "ลิสบอน", bud: "บูดาเปสต์", nyc: "นิวยอร์ก", mex: "เม็กซิโกซิตี้", bue: "บัวโนสไอเรส", rio: "ริโอเดจาเนโร", bog: "โบโกตา", lim: "ลิมา", scl: "ซันติอาโก", yyz: "โตรอนโต", chi: "ชิคาโก", sfo: "ซานฟรานซิสโก", tyo: "โตเกียว", sel: "โซล", bkk: "กรุงเทพฯ", pek: "ปักกิ่ง", sin: "สิงคโปร์", dxb: "ดูไบ", bom: "มุมไบ", ist: "อิสตันบูล", hkg: "ฮ่องกง", han: "ฮานอย", rak: "มาราเกช", cai: "ไคโร", cpt: "เคปทาวน์", nbo: "ไนโรบี", tun: "ตูนิส", cas: "คาซาบลังกา", los: "ลากอส", dkr: "ดาการ์", syd: "ซิดนีย์", mel: "เมลเบิร์น", akl: "โอ๊คแลนด์", bne: "บริสเบน", per: "เพิร์ท", ool: "โกลด์โคสต์" }
    },
    ro: { 
        hubTitle: "Intel Hub", hubSub: "Bază de Date Globală", homeTitle: "Explorează Spania", homeSub: "Masterclass-uri Naționale", 
        catCapitales: "Mari Capitale", catVisitadas: "Cele mai Vizitate", catPueblos: "Sate cu Farmec", catJoyas: "Bijuterii Ascunse",
        catEuropa: "Europa", catAmerica: "America", catAsia: "Asia", catAfrica: "Africa", catOceania: "Oceania",
        countries: { esp: "Spania", fra: "Franța", gbr: "Regatul Unit", deu: "Germania", ita: "Italia", nld: "Olanda", cze: "Cehia", aut: "Austria", grc: "Grecia", prt: "Portugalia", hun: "Ungaria", usa: "SUA", mex: "Mexic", arg: "Argentina", bra: "Brazilia", col: "Columbia", per: "Peru", chl: "Chile", can: "Canada", jpn: "Japonia", kor: "Coreea de Sud", tha: "Thailanda", chn: "China", sgp: "Singapore", are: "EAU", ind: "India", tur: "Turcia", vnm: "Vietnam", mar: "Maroc", egy: "Egipt", zaf: "Africa de Sud", ken: "Kenya", tun: "Tunisia", nga: "Nigeria", sen: "Senegal", aus: "Australia", nzl: "Noua Zeelandă" },
        cities: { mad: "Madrid", bcn: "Barcelona", vlc: "Valencia", svq: "Sevilla", grx: "Granada", agp: "Malaga", pmi: "Palma", bio: "Bilbao", ron: "Ronda", cad: "Cadaques", alb: "Albarracin", cud: "Cudillero", ter: "Teruel", sor: "Soria", ube: "Ubeda", cac: "Caceres", par: "Paris", lon: "Londra", ber: "Berlin", rom: "Roma", ams: "Amsterdam", prg: "Praga", vie: "Viena", ath: "Atena", lis: "Lisabona", bud: "Budapesta", nyc: "New York", mex: "Ciudad de Mexico", bue: "Buenos Aires", rio: "Rio de Janeiro", bog: "Bogota", lim: "Lima", scl: "Santiago", yyz: "Toronto", chi: "Chicago", sfo: "San Francisco", tyo: "Tokyo", sel: "Seul", bkk: "Bangkok", pek: "Beijing", sin: "Singapore", dxb: "Dubai", bom: "Mumbai", ist: "Istanbul", hkg: "Hong Kong", han: "Hanoi", rak: "Marrakech", cai: "Cairo", cpt: "Cape Town", nbo: "Nairobi", tun: "Tunis", cas: "Casablanca", los: "Lagos", dkr: "Dakar", syd: "Sydney", mel: "Melbourne", akl: "Auckland", bne: "Brisbane", per: "Perth", ool: "Gold Coast" }
    }
};
...
export const TravelServices: React.FC<any> = ({ mode, language = 'es', onCitySelect }) => {
    // IMPORTANTE: Detectamos el diccionario o fallback a español
    const l = UI_LABELS[language] || UI_LABELS.es;
    const [activeTab, setActiveTab] = useState<string>('europa');

    // Funciones seguras de traducción: Busca en el idioma actual -> Inglés -> Key original
