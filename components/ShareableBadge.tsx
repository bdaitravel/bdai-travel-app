      ...
      if (navigator.canShare && navigator.canShare({ files: [file] })) {
        try {
          await navigator.share({
            ...
            text: `I just reached ${rank} rank with ${miles.toLocaleString()} miles on bdai.travel! 🌍✨ #bdai #travel`,
          });
          ...
          if (shareError.name === 'AbortError') {
            ...
            toast("📸 ¡Insignia guardada! Abre Instagram para compartirla. ✨", "success");
            setStatusText('✅ READY TO SHARE');
          }
        }
      } else {
