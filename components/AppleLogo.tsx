...
// Logomark oficial "Sign in with Apple" (Apple Design Resources, variante
// "Logo-only"), sin el rect de fondo del asset original — el botón ya pone su
// propio fondo negro/blanco. No modificar el path: es el trazado tal cual lo
