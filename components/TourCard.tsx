...
export const TourCard: React.FC<any> = ({ tour, onSelect, language = 'es' }) => {
  ...
  // Asegurar que siempre haya un título visible
  const displayTitle = tour.title || tl.defaultTitle || "Tour BDAI";
    ...
    >
      <div className="flex flex-col">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-[7px] font-black bg-purple-600/20 text-purple-400 px-2 py-0.5 rounded-full uppercase tracking-widest border border-purple-500/20">Dai Intel</span>
            {tour.isEssential && <span className="text-[7px] font-black bg-amber-600/20 text-amber-400 px-2 py-0.5 rounded-full uppercase tracking-widest border border-amber-500/20">Top</span>}
          </div>
          ...
          <div className="flex items-center justify-between pt-6 border-t border-white/5">
               <div className="flex gap-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-white font-black text-xs uppercase tracking-tighter">{tour.duration || '2h'}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[7px] font-black text-slate-600 uppercase tracking-widest">{tl.distance}</span>
                    <span className="text-white font-black text-xs uppercase tracking-tighter">{tour.distance || '3km'}</span>
                  </div>
               </div>
