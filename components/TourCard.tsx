...
const TEXTS: any = {
    ...
    de: { start: "Starten", stop: "Halt", of: "von", daiShot: "Dai Tipp", angleLabel: "Dai Winkel:", photoTipFallback: "Suchen Sie nach einer Seitenperspektive.", capture: "Daten loggen", rewardReceived: "Synchronisiert", prev: "Zurück", next: "Weiter", meters: "m", itinerary: "Reiseroute", finish: "Tour beenden", congrats: "Tour abgeschlossen!", stampDesc: "Neuer Stempel erhalten", shareIg: "Teilen (+100 Meilen)", close: "Schließen", tooFar: "GPS unsicher", checkIn: "GPS Check-in", checkedIn: "Verifiziert", distance: "Distanz", duration: "Dauer", nearbyAlert: "Halt in der Nähe", jumpTo: "Hierher springen", rewardMiles: "+50 MEILEN", visaId: "VISUM", boardingPass: "BORDKARTE", approved: "GENEHMIGT", rewardTotal: "Gesamtbelohnung", rankUp: "Rang aktualisiert" },
    it: { start: "Avvia", stop: "Fermata", of: "di", daiShot: "Consiglio Dai", angleLabel: "Angolo Dai:", photoTipFallback: "Cerca una prospettiva laterale.", capture: "Registra Dati", rewardReceived: "Sincronizzato", prev: "Indietro", next: "Avanti", meters: "m", itinerary: "Itinerario", finish: "Termina Tour", congrats: "Tour Completato!", stampDesc: "Nuovo timbro guadagnato", shareIg: "Condividi (+100 Miglia)", close: "Chiudi", tooFar: "GPS Incerto", checkIn: "Check-in GPS", checkedIn: "Verificato", distance: "Distanza", duration: "Durata", nearbyAlert: "Fermata Vicina", jumpTo: "Vai qui", rewardMiles: "+50 MIGLIA", visaId: "VISTO", boardingPass: "CARTA D'IMBARCO", approved: "APPROVATO", rewardTotal: "Premio totale", rankUp: "Rango aggiornato" },
    pt: { start: "Lançar", stop: "Parada", of: "de", daiShot: "Conselho Dai", angleLabel: "Ângulo Dai:", photoTipFallback: "Procure uma perspectiva lateral.", capture: "Log Dados", rewardReceived: "Sincronizado", prev: "Atrás", next: "Próximo", meters: "m", itinerary: "Itinerário", finish: "Terminar Tour", congrats: "Tour Concluído!", stampDesc: "Novo selo ganho", shareIg: "Partilhar (+100 Milhas)", close: "Fechar", tooFar: "GPS Incerto", checkIn: "Check-in GPS", checkedIn: "Verificada", distance: "Distância", duration: "Duração", nearbyAlert: "Parada Próxima", jumpTo: "Saltar aqui", rewardMiles: "+50 MILHAS", visaId: "VISTO", boardingPass: "CARTÃO DE EMBARQUE", approved: "APROVADO", rewardTotal: "Recompensa total", rankUp: "Classificação atualizada" },
    ro: { start: "Lansează", stop: "Oprire", of: "din", daiShot: "Sfatul Dai", angleLabel: "Unghi Dai:", photoTipFallback: "Caută o perspectivă laterală.", capture: "Log Date", rewardReceived: "Sincronizat", prev: "Înapoi", next: "Înainte", meters: "m", itinerary: "Itinerariu", finish: "Finalizare Tur", congrats: "Tur Completat!", stampDesc: "Ai câștigat o viză nouă", shareIg: "Distribuie (+100 Mile)", close: "Închide", tooFar: "GPS Incert", checkIn: "Check-in GPS", checkedIn: "Verificat", distance: "Distanță", duration: "Durată", nearbyAlert: "Oprire Apropiată", jumpTo: "Sari aici", rewardMiles: "+50 MILE", visaId: "VIZĂ", boardingPass: "BILET ÎMBARCARE", approved: "APROBAT", rewardTotal: "Recompensă totală", rankUp: "Rang actualizat" },
    ja: { start: "開始", stop: "停留所", of: "の", daiShot: "Daiのアドバイス", angleLabel: "Daiの角度:", photoTipFallback: "横からのパースを狙ってください。", capture: "ログデータ", rewardReceived: "同期済み", prev: "戻る", next: "次へ", meters: "m", itinerary: "旅程", finish: "ツアー終了", congrats: "ツアー完了！", stampDesc: "新しいスタンプを獲得", shareIg: "シェア (+100マイル)", close: "閉じる", tooFar: "GPS不安定", checkIn: "GPSチェックイン", checkedIn: "確認済み", distance: "距離", duration: "時間", nearbyAlert: "近くの停留所", jumpTo: "ここへ移動", rewardMiles: "+50マイル", visaId: "ビザ", boardingPass: "搭乗券", approved: "承認済み", rewardTotal: "合計リワード", rankUp: "ランク更新" },
    zh: { start: "开始", stop: "站点", of: "的", daiShot: "Dai 建议", angleLabel: "Dai 角度:", photoTipFallback: "寻找侧视角以捕捉深度。", capture: "记录数据", rewardReceived: "已同步", prev: "后退", next: "下一步", meters: "米", itinerary: "行程", finish: "结束导览", congrats: "导览完成！", stampDesc: "获得新印章", shareIg: "分享 (+100 里程)", close: "关闭", tooFar: "GPS 不稳定", checkIn: "GPS 签到", checkedIn: "已验证", distance: "距离", duration: "时长", nearbyAlert: "附近站点", jumpTo: "跳转至此", rewardMiles: "+50 里程", visaId: "签证", boardingPass: "登机牌", approved: "已通过", rewardTotal: "总奖励", rankUp: "等级提升" },
    hi: { start: "शुरू करें", stop: "पड़ाव", of: "का", daiShot: "दाई टिप", angleLabel: "दाई कोण:", photoTipFallback: "पार्श्व परिप्रेक्ष्य देखें।", capture: "डेटा लॉग करें", rewardReceived: "सिंक किया गया", prev: "पीछे", next: "अगला", meters: "मी", itinerary: "यात्रा कार्यक्रम", finish: "दौरा समाप्त करें", congrats: "दौरा पूरा हुआ!", stampDesc: "नया स्टाम्प मिला", shareIg: "साझा करें (+100 मील)", close: "बंद करें", tooFar: "GPS अनिश्चित", checkIn: "GPS चेक-इन", checkedIn: "सत्यापित", distance: "दूरी", duration: "अवधि", nearbyAlert: "पास का स्टॉप", jumpTo: "यहाँ कूदें", rewardMiles: "+50 मील", visaId: "वीजा", boardingPass: "बोर्डिंग पास", approved: "अनुमोदित", rewardTotal: "कुल इनाम", rankUp: "रैंक अपडेट किया गया" }
};
