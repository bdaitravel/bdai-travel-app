...
const UI_TEXT: any = {
    en: { next: "Next", prev: "Back", listen: "Audio Guide", pause: "Pause", checkin: "Check In", collected: "Verified!", stop: "Stop", deepDive: "AI Deep Dive", enriching: "Investigating...", photoSpotTitle: "Perfect Shot", angle: "Suggested Angle", bestTime: "Best Time", instaHook: "Instagram Hook", copyBtn: "Copy & Share", preview: "Preview", start: "Start", stopPreview: "Stop", copied: "Hook copied! Open Instagram to share." },
    es: { next: "Siguiente", prev: "Atrás", listen: "Audio Guía", pause: "Pausar", checkin: "Check In", collected: "¡Verificado!", stop: "Parada", deepDive: "Inmersión IA", enriching: "Investigando...", photoSpotTitle: "Foto Perfecta", angle: "Encuadre Sugerido", bestTime: "Mejor Momento", instaHook: "Hook Instagram", copyBtn: "Copiar y Compartir", preview: "Escuchar", start: "Empezar", stopPreview: "Parar", copied: "¡Hook copiado! Abre Instagram para compartir." },
    eu: { next: "Hurrengoa", prev: "Atzera", listen: "Audio Gida", pause: "Gelditu", checkin: "Check In", collected: "Egiaztatuta!", stop: "Geldialdia", deepDive: "AI Sakontzea", enriching: "Ikertzen...", photoSpotTitle: "Argazki Perfektua", angle: "Iradokitako enkoadraketa", bestTime: "Une onena", instaHook: "Instagramerako Hook-a", copyBtn: "Kopiatu eta Partekatu", preview: "Entzun", start: "Hasi", stopPreview: "Gelditu", copied: "Hook-a kopiatuta! Ireki Instagram partekatzeko." },
    ca: { next: "Següent", prev: "Enrere", listen: "Audio Guia", pause: "Pausa", checkin: "Check In", collected: "Verificat!", stop: "Parada", deepDive: "Immersió IA", enriching: "Investigant...", photoSpotTitle: "Foto Perfecta", angle: "Enquadrament Suggerit", bestTime: "Millor Moment", instaHook: "Hook Instagram", copyBtn: "Copiar i Compartir", preview: "Escolta", start: "Començar", stopPreview: "Aturar", copied: "Hook copiat! Obre Instagram per compartir." },
    fr: { next: "Suivant", prev: "Retour", listen: "Guide Audio", pause: "Pause", checkin: "S'enregistrer", collected: "Vérifié!", stop: "Arrêt", deepDive: "Immersion IA", enriching: "Recherche...", photoSpotTitle: "Photo Parfaite", angle: "Angle Suggéré", bestTime: "Meilleur Moment", instaHook: "Hook Instagram", copyBtn: "Copier et Partager", preview: "Aperçu", start: "Commencer", stopPreview: "Pause", copied: "Lien copié ! Ouvrez Instagram pour partager." },
    de: { next: "Weiter", prev: "Zurück", listen: "Audioguide", pause: "Pause", checkin: "Einchecken", collected: "Verifiziert!", stop: "Halt", deepDive: "KI-Tiefgang", enriching: "Untersuchung...", photoSpotTitle: "Perfektes Foto", angle: "Empfohlener Winkel", bestTime: "Beste Zeit", instaHook: "Instagram-Hook", copyBtn: "Kopieren & Teilen", preview: "Vorschau", start: "Starten", stopPreview: "Stopp", copied: "Hook kopiert! Öffne Instagram zum Teilen." },
    pt: { next: "Próximo", prev: "Voltar", listen: "Guia de Áudio", pause: "Pausa", checkin: "Check In", collected: "Verificado!", stop: "Parada", deepDive: "Imersão IA", enriching: "Investigando...", photoSpotTitle: "Foto Perfeita", angle: "Ângulo Sugerido", bestTime: "Melhor Momento", instaHook: "Hook do Instagram", copyBtn: "Copiar e Compartilhar", preview: "Ouvir", start: "Começar", stopPreview: "Parar", copied: "Hook copiado! Abre o Instagram para partilhar." },
    ar: { next: "التالي", prev: "السابق", listen: "دليل صوتي", pause: "إيقاف", checkin: "تسجيل الوصول", collected: "تم التحقق!", stop: "محطة", deepDive: "غوص عميق بالذكاء الاصطناعي", enriching: "جارٍ التحقيق...", photoSpotTitle: "لقطة مثالية", angle: "الزاوية المقترحة", bestTime: "أفضل وقت", instaHook: "جملة إنستغرام", copyBtn: "نسخ ومشاركة", preview: "معاينة", start: "ابدأ", stopPreview: "إيقاف", copied: "تم النسخ! افتح إنستغرام للمشاركة." },
    zh: { next: "下一步", prev: "返回", listen: "语音导览", pause: "暂停", checkin: "签到", collected: "已验证！", stop: "站点", deepDive: "AI 深度解析", enriching: "正在调查...", photoSpotTitle: "完美快照", angle: "建议角度", bestTime: "最佳时间", instaHook: "Instagram 钩子", copyBtn: "复制并分享", preview: "试听", start: "开始", stopPreview: "停止", copied: "已复制！打开 Instagram 进行分享。" },
    ja: { next: "次へ", prev: "戻る", listen: "オーディオガイド", pause: "一時停止", checkin: "チェックイン", collected: "確認済み！", stop: "停留所", deepDive: "AIディープダイブ", enriching: "調査中...", photoSpotTitle: "パーフェクトショット", angle: "推奨アングル", bestTime: "ベストタイム", instaHook: "Instagramフック", copyBtn: "コピーして共有", preview: "プレビュー", start: "開始", stopPreview: "停止", copied: "コピーしました！Instagramでシェアしましょう。" }
};
