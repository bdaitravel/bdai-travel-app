...
const LEGAL_TEXTS: Record<string, any> = {
  es: {
    privacy: { title: "Política de Privacidad", updated: "Última actualización: 12 de Septiembre de 2026", intro: "En bdai, respetamos su privacidad y estamos comprometidos a proteger sus datos personales.", s1title: "1. Información que recopilamos", s1: "Al usar la app por primera vez, se crea automáticamente un identificador de usuario anónimo, sin necesidad de facilitar ningún dato personal. Si más adelante decide vincular su cuenta con Apple, Google o email, recopilamos ese dato de acceso. De forma voluntaria, puede indicarnos también en su perfil: fecha de nacimiento, ciudad, país y sexo. También recopilamos datos de ubicación GPS cuando usa la app para desbloquear paradas y ganar millas.", s2title: "2. Cómo usamos su información", s2: "Utilizamos su información para proporcionar y mejorar nuestros servicios, personalizar su experiencia y gestionar su cuenta.", s3title: "3. Compartir su información", s3: "No vendemos sus datos personales a terceros. Podemos compartir información anonimizada con ayuntamientos y comercios locales para mejorar la experiencia turística.", s4title: "4. Sus derechos (RGPD)", s4: "Tiene derecho a acceder, rectificar y solicitar la eliminación de sus datos. Puede ejercer su derecho al olvido eliminando su cuenta desde el perfil, incluidos los perfiles anónimos.", s5title: "5. Contacto", s5: "Daysi Chong Zambrano — NIF: 16648955Z — Calle Calvo Sotelo 34, Logroño, La Rioja 26003 — info@bdai.travel" },
  ...
  en: {
    privacy: { title: "Privacy Policy", updated: "Last updated: September 12, 2026", intro: "At bdai, we respect your privacy and are committed to protecting your personal data.", s1title: "1. Information We Collect", s1: "When you use the app for the first time, an anonymous user identifier is created automatically, with no need to provide any personal data. If you later choose to link your account with Apple, Google or email, we collect that sign-in data. You may also voluntarily tell us, in your profile: date of birth, city, country and gender. We also collect GPS location data when you use the app to unlock stops and earn miles.", s2title: "2. How We Use Your Information", s2: "We use your information to provide and improve our services, personalize your experience and manage your account.", s3title: "3. Sharing Your Information", s3: "We do not sell your personal data to third parties. We may share anonymized information with local governments and businesses to improve the tourism experience.", s4title: "4. Your Rights (GDPR)", s4: "You have the right to access, rectify and request deletion of your data. You can delete your account from the profile section, including anonymous profiles.", s5title: "5. Contact", s5: "Daysi Chong Zambrano — NIF: 16648955Z — Calle Calvo Sotelo 34, Logroño, La Rioja 26003 — info@bdai.travel" },
