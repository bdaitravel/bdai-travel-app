...
const LEGAL_TEXTS: Record<string, any> = {
  ...
  de: {
    privacy: { title: "Datenschutzrichtlinie", updated: "Letzte Aktualisierung: 14. März 2026", intro: "Bei bdai respektieren wir Ihre Privatsphäre.", s1title: "1. Daten", s1: "Name, E-Mail, Alter, Stadt, Land, Sprache und GPS-Daten.", s2title: "2. Verwendung", s2: "Wir verbessern unsere Dienste mit Ihren Daten.", s3title: "3. Weitergabe", s3: "Kein Verkauf an Dritte.", s4title: "4. Rechte (DSGVO)", s4: "Recht auf Zugang, Berichtigung und Löschung.", s5title: "5. Kontakt", s5: "Daysi Chong Zambrano — info@bdai.travel" },
    terms: { title: "Nutzungsbedingungen", updated: "Letzte Aktualisierung: 14. März 2026", intro: "Willkommen bei bdai.", s1title: "1. Nutzung", s1: "Nur für legale Zwecke.", s2title: "2. Konten", s2: "Sie sind für Ihre Anmeldedaten verantwortlich.", s3title: "3. Inhalte", s3: "Nicht-exklusive weltweite Lizenz.", s4title: "4. Meilen", s4: "Kein Geldwert.", s5title: "5. Kontakt", s5: "Daysi Chong Zambrano — info@bdai.travel" }
  },
  ru: {
