...
const TRANSLATIONS: any = {
  ...
  zh: { welcome: "bidaer 日志:", explorer: "探险家", searchPlaceholder: "城市...", emailPlaceholder: "你的@email.com", userPlaceholder: "用户名", login: "申请访问", verify: "验证", tagline: "better destinations by ai", selectLang: "语言", navElite: "精英", navHub: "情报", navVisa: "护照", navStore: "商店", changeEmail: "纠正", sentTo: "已发送至", info: "信息" },
  ca: { welcome: "log bidaer:", explorer: "explorador", searchPlaceholder: "ciutat...", emailPlaceholder: "el-teu@email.com", userPlaceholder: "usuari", login: "sol·licitar accés", verify: "validar", tagline: "better destinations by ai", selectLang: "idioma", navElite: "elit", navHub: "intel", navVisa: "passaport", navStore: "botiga", changeEmail: "corregir", sentTo: "enviat a", info: "info" },
  eu: { welcome: "bidaer log:", explorer: "esploratzailea", searchPlaceholder: "hiria...", emailPlaceholder: "zure@email.com", userPlaceholder: "erabiltzailea", login: "sarrera eskatu", verify: "balioztatu", tagline: "better destinations by ai", selectLang: "hizkuntza", navElite: "elitea", navHub: "intel", navVisa: "pasaportea", navStore: "denda", changeEmail: "zuzendu", sentTo: "hona bidalia", info: "info" },
  ar: { welcome: "سجل bidaer:", explorer: "مستكشف", searchPlaceholder: "مدينة...", emailPlaceholder: "بريدك@الإلكتروني", userPlaceholder: "اسم المستخدم", login: "طلب الدخول", verify: "تحقق", tagline: "better destinations by ai", selectLang: "اللغة", navElite: "النخبة", navHub: "ذكاء", navVisa: "جواز السفر", navStore: "متجر", changeEmail: "تصحيح", sentTo: "تم الإرسال إلى", info: "معلومات" },
  pt: { welcome: "registro bidaer:", explorer: "explorador", searchPlaceholder: "cidade...", emailPlaceholder: "seu@email.com", userPlaceholder: "usuário", login: "acesso", verify: "validar", tagline: "better destinations by ai", selectLang: "idioma", navElite: "elite", navHub: "intel", navVisa: "pasaporte", navStore: "loja", changeEmail: "corrigir", sentTo: "enviado para", info: "info" },
  fr: { welcome: "journal bidaer:", explorer: "explorateur", searchPlaceholder: "ville...", emailPlaceholder: "votre@email.com", userPlaceholder: "utilisateur", login: "accès", verify: "valider", tagline: "better destinations by ai", selectLang: "langue", navElite: "élite", navHub: "intel", navVisa: "passeport", navStore: "boutique", changeEmail: "corriger", sentTo: "envoyé à", info: "info" },
  de: { welcome: "bidaer log:", explorer: "entdecker", searchPlaceholder: "stadt...", emailPlaceholder: "deine@email.com", userPlaceholder: "benutzer", login: "zugang", verify: "bestätigen", tagline: "better destinations by ai", selectLang: "sprache", navElite: "elite", navHub: "intel", navVisa: "pass", navStore: "shop", changeEmail: "korrigieren", sentTo: "gesendet an", info: "info" },
  it: { welcome: "diario bidaer:", explorer: "esploratore", searchPlaceholder: "città...", emailPlaceholder: "tua@email.com", userPlaceholder: "utente", login: "accesso", verify: "valida", tagline: "better destinations by ai", selectLang: "lingua", navElite: "élite", navHub: "intel", navVisa: "passaporto", navStore: "negozio", changeEmail: "correggere", sentTo: "inviato a", info: "info" },
