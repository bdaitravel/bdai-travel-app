                ...
                {!searchVal && (
                    <div className="mt-12 flex flex-col items-center justify-center animate-slide-up pb-10 relative z-10">
                        ...
                        <div className="grid grid-cols-2 gap-4 w-full">
                            ...
                            <QuickCityBtn onClick={() => handleCitySelect('Granada')} label={t('lblGranada')} city="Granada 🕌" color="purple" />
                            <QuickCityBtn onClick={() => handleCitySelect('Bilbao')} label={t('lblBilbao')} city="Bilbao 🏗️" color="indigo" />
                            <QuickCityBtn onClick={() => handleCitySelect('Santiago de Compostela')} label={t('lblSantiago')} city="Santiago ⛪" color="blue" />
                            <QuickCityBtn onClick={() => handleCitySelect('Málaga')} label={t('lblMalaga')} city="Málaga ☀️" color="orange" />
                            <QuickCityBtn onClick={() => handleCitySelect('Zaragoza')} label={t('lblZaragoza')} city="Zaragoza 🏛️" color="purple" />
                        </div>
                    </div>
                )}
            </div>
